		...
		<div class="col-sm-6">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form action="enp_register" method="post" autocomplete="off">
						<div class="row">
							<div class="col-lg-12">
									...
									<div class="form-group">
										<label>Negative Password</label>
                                                                                <textarea class="form-control" name="ndb" id="ndb" rows="4"><%=ndb%></textarea>
									</div>
                                                                        <div class="form-group">
						...
						<button type="submit" class="pull-right btn btn-info">Register</button>
					</form>
				</div>
                            </div>
			</div>
